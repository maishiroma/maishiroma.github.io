...
function expandPreview(idOfPreview) {
     ...
     switch (idOfPreview) {
          case "NebulaworksCloudEngineer":
               header = "Cloud Engineer <i>(April 2019 - Current)</i>";
               message = "<p>Returned as a full time Cloud Engineer, I partook in multiple endevours for the company, some of which include: </p>" +
                    "<ul>" +
                    "<li>Engaging with clients who are looking to adopt cloud platforms, using best practices</li>" +
                    "<li>Actively improving the internal environment that we have at Nebulaworks, taking time to proof out tools and concepts</li>" +
                    "<li>Advocated open source software, leading discussions and asking questions at public meetup groups (i.e. CloudNatives)</li>" +
                    "<li>Educating the general public with free insightful blog posts, commentary and whiteboard videos</li>" +
                    "</ul>" +
                    "<p>Some of the skills that I am using for this job include (but are not limited to): </p>" +
                    "<ul>" +
                    "<li>Trunk Based Development</li>" +
                    "<li>CLI tools such as Terraform, Docker, Helm, Kubernetes</li>" +
                    "<li>Communication, Team and Writing Skills</li>" +
                    "<li>Self Responsibility for tasks, self learning</li>" +
                    "</ul>";
               modalImage1.src = "assets/images/portfolio/NebulaworksNew2.png";
               modalImage2.src = "assets/images/portfolio/NebulaworksNew3.png";
               modalVideoImage.src = "https://upload.wikimedia.org/wikipedia/commons/b/b1/Loading_icon.gif";
               modalVideo.src = "https://www.youtube.com/embed/R_v4rnsbbIM?enablejsapi=1&rel=0";
               hasVideo = true;
               break;
          case "NebulaworksDevOpsSpecialist":
